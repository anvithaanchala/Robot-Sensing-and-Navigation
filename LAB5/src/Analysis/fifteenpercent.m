%Cinder block images are calibrated using calibration gui: Image Names -> Load .mat -> Undistort Image
%Loading calibrated images 
buildingDir = fullfile("C:\Users\anvit\OneDrive\Desktop\RSN\LAB5\mosaic_1");
...
grayImage = im2gray(I);
[y,x,m] = harris(grayImage, 10000, 'tile', [5 5], 'disp');
...
for n = 2:numImages
    ...
    [y,x,m] = harris(grayImage, 5000, 'tile', [8 8], 'disp');
    points = cornerPoints([x, y]);
    [features, points] = extractFeatures(grayImage, points);
    ...
    tforms(n) = estgeotform2d(matchedPoints, matchedPointsPrev,"projective","Confidence",99,'MaxNumTrials', 2000);
